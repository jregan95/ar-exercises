...
# We haven't used the Employee class (and employees table) at all yet. If you look at 
# this table's column structure, you'll find that it has a `store_id` (integer) column. 
...
@store1.employees.create(first_name: "Jill", last_name: "Regan", hourly_rate: 50)

@store2.employees.create(first_name: "Steve", last_name: "John", hourly_rate: 60)
@store2.employees.create(first_name: "Dots", last_name: "Regan", hourly_rate: 70)
